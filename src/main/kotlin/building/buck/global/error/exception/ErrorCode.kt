...
enum class ErrorCode(
    ...
    COLLECTION_IN_PROGRESS(409, "Collection Already In Progress"),
    ...
    TIMELINE_ITEM_NOT_FOUND(404, "Timeline Item Not Found"),
    SseEmitterAlreadyCompletedException(400,""),

    NOT_ADMIN(403, "Not an Admin"),
    NOT_STUDENT(403, "Not an Student"),
    NOT_POST_AUTHOR(403, "Not Post Author"),
    NOT_TIMELINE_OWNER(403, "Not Timeline Owner"),
    ...
    CANNOT_FOLLOW_SELF(400, "Cannot Follow Self"),
